...
void RTC_Read(unsigned char);

unsigned char Hexa_to_BCD(unsigned char);

void set_sec(unsigned char);
void set_min(unsigned char);
void set_hour(unsigned char, unsigned char);
void set_day(unsigned char);
void set_date(unsigned char);
void set_mon(unsigned char);
void set_year(unsigned char);


void set_time(unsigned char, unsigned char, unsigned char, unsigned char, unsigned char, unsigned char, unsigned char, unsigned char);

void LCD_display(void);
void display_min(unsigned char);
void display_sec(unsigned char);
void display_date(unsigned char);
void display_hr(unsigned char);
void display_mon(unsigned char);
void display_year(unsigned char);
void display_day(unsigned char);

unsigned char MSB(unsigned char);
unsigned char LSB(unsigned char);
...
void main(void) {
    ...
    LCD_init();
    set_time(34, 59, 12, 0, 6, 21, 12, 24);
...
void LCD_display(void) {
    ...
    display_hr(rd_time[2]);
    display_min(rd_time[1]);
    display_sec(rd_time[0]);
    display_date(rd_time[4]);
    display_mon(rd_time[5]);
    display_year(rd_time[6]);
    display_day(rd_time[3]);
}
...
void display_day(unsigned char day) {
    ...
    switch(day) {
        ...
        case(1):
            data('S');data('U');data('N');break;
        case(2):
            data('M');data('O');data('N');break;
        case(3):
            data('T');data('U');data('E');break;
        case(4):
            data('W');data('E');data('D');break;
        case(5):
            data('T');data('H');data('U');break;
        case(6):
            data('F');data('R');data('I');break;
        case(7):
            data('S');data('A');data('T');break;
...
void display_mon(unsigned char mon) {
    ...
    mon &= ~0x80;
    mon = (10*(MSB(mon))) + LSB(mon);
    switch(mon) {

        case(1):
            data('J');data('A');data('N');break;
        case(2):
            data('F');data('E');data('B');break;
        case(3):
            data('M');data('A');data('R');break;
        case(4):
            data('A');data('P');data('R');break;
        case(5):
            data('M');data('A');data('Y');break;
        case(6):
            data('J');data('U');data('N');break;
        case(7):
            data('J');data('U');data('L');break;
        case(8):
            data('A');data('U');data('G');break;
        case(9):
            data('S');data('E');data('P');break;
        case(10):
            data('O');data('C');data('T');break;
        case(11):
            data('N');data('O');data('V');break;
        case(12):
            data('D');data('E');data('C');break;
    }
...
void set_hour(unsigned char hour, unsigned char state) {
    unsigned char hr_data = Hexa_to_BCD(hour);
    if (hour>12){
...
void set_sec(unsigned char sec){
    ...
    unsigned char sec_data = Hexa_to_BCD(sec);
    wr_time[0] = sec_data;
}

void set_min(unsigned char min){

    unsigned char min_data = Hexa_to_BCD(min);
    wr_time[1] = min_data;
}

void set_date(unsigned char date){

    unsigned char date_data = Hexa_to_BCD(date);
    wr_time[4] = date_data;
}

void set_mon(unsigned char mon){

    unsigned char mon_data = Hexa_to_BCD(mon);
    wr_time[5] = mon_data;
}

void set_year(unsigned char year){

    unsigned char year_data = Hexa_to_BCD(year);
    wr_time[6] = year_data;
}
...
unsigned char Hexa_to_BCD(unsigned char data){
    ...
    unsigned char ones = data%10;
    unsigned char tens = (data - ones)/10;

    unsigned char MSB = (tens<<4);
    unsigned char LSB = ones;
