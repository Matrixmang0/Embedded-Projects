...
# 19 "7-seg_Interfacing.c" 2




void init(void);
unsigned char calibrate(unsigned char);
...
unsigned char calibrate(unsigned char counter) {
    ...
    unsigned char rdig = (counter%10);
    unsigned char ldig = ((counter-rdig)/10);
...
void right(unsigned char r) {
    ...
    unsigned char arr[10] = {0x3F,0x30,0x6D,0x79,0x72,0x5B,0x5F,0x31,0x7F,0x73};
    PORTD = arr[r];
}
